...
namespace Illuminate\Support\Facades {
    ...
    /**
     * @see \Illuminate\Contracts\Foundation\Application::environmentPath
     ...
     * @see \Illuminate\Contracts\Foundation\Application::routesAreCached
     ...
     * @see \Illuminate\Contracts\Foundation\Application::loadEnvironmentFrom
     ...
     * @see \Illuminate\Contracts\Foundation\Application::environmentFile
     * @method static string environmentFile()
     * @see \Illuminate\Contracts\Foundation\Application::configurationIsCached
     ...
     * @see \Illuminate\Contracts\Foundation\Application::detectEnvironment
     * @method static string detectEnvironment(\Closure $callback)
     * @see \Illuminate\Contracts\Foundation\Application::getCachedServicesPath
     ...
     * @see \Illuminate\Contracts\Foundation\Application::getCachedPackagesPath
     ...
     * @see \Illuminate\Contracts\Foundation\Application::environmentFilePath
     * @method static string environmentFilePath()
     * @see \Illuminate\Contracts\Foundation\Application::getCachedRoutesPath
     ...
     * @see \Illuminate\Contracts\Foundation\Application::getCachedConfigPath
     ...
     * @method static void component(string $path, null|string $alias = null)
     ...
     * @method static null|string getBaseUrl()
     ...
     * @method static \Illuminate\Routing\Route|object|string route(null|string $param = null, $default = null)
     ...
     * @method static string transChoice(string $key, array|\Countable|int $number, array $replace = [], null|string $locale = null)
     ...
     * @method static array|string getFromJson(string $key, array $replace = [], null|string $locale = null)
     ...
     * @method static array|string trans(string $key, array $replace = [], null|string $locale = null)
     ...
     * @method static \Illuminate\Http\JsonResponse jsonp(string $callback, array|object|string $data = [], int $status = 200, array $headers = [], int $options = 0)
     ...
     * @method static \Illuminate\Http\JsonResponse json(array|object|string $data = [], int $status = 200, array $headers = [], int $options = 0)
     ...
     * @method static \Illuminate\Routing\Route put(string $uri, array|callable|\Closure|null|string $action = null)
     * @see \Illuminate\Routing\Router::permanentRedirect
     * @method static \Illuminate\Routing\Route permanentRedirect(string $uri, string $destination)
     * @see \Illuminate\Routing\Router::patch
     * @method static \Illuminate\Routing\Route patch(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static \Illuminate\Routing\Route post(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static \Illuminate\Routing\Route options(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static \Illuminate\Http\JsonResponse|\Illuminate\Http\Response respondWithRoute(string $name)
     ...
     * @method static \Illuminate\Routing\Route addRoute(array|string $methods, string $uri, array|callable|\Closure|null|string $action)
     ...
     * @method static \Illuminate\Http\JsonResponse|\Illuminate\Http\Response dispatchToRoute(\Illuminate\Http\Request $request)
     ...
     * @see \Illuminate\Routing\Router::emailVerification
     ...
     * @method static \Illuminate\Routing\Route fallback(array|callable|\Closure|null|string $action)
     ...
     * @method static \Illuminate\Routing\Route delete(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static \Illuminate\Routing\Route get(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @see \Illuminate\Routing\Router::resetPassword
     ...
     * @method static \Illuminate\Routing\Route match(array|string $methods, string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static \Illuminate\Routing\Route any(string $uri, array|callable|\Closure|null|string $action = null)
     ...
     * @method static mixed pull(string $key, null|string $default = null)
     ...
     * @method static string signedRoute(string $name, array $parameters = [], \DateInterval|\DateTimeInterface|int|null $expiration = null, bool $absolute = true)
