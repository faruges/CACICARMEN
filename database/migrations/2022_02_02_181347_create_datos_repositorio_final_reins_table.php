...
class CreateDatosRepositorioFinalReinsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('datos_repositorio_final_reins', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedInteger('inscripcion_menor_id');
            $table->foreign('inscripcion_menor_id')->references('id')->on('reinscripcion_menor')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->string('horario_ent_laboral_padre',30);
            $table->string('horario_sal_laboral_padre',30);
            $table->string('dias_laborales_padre',100)->nullable();
            $table->string('nombre_segundo_empleo',200)->nullable();
            $table->string('horario_ent_laboral_segundo_empleo',10)->nullable();
            $table->string('horario_sal_laboral_segundo_empleo',10)->nullable();
    ...
    {
        Schema::dropIfExists('datos_repositorio_final_reins');
    }
}
