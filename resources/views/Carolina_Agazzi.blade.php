...
<div class="accordions">
  <div class="accordion-item">
   ...
   <i style="text-align: right;" class="fa fa-sign-out"></i>
</a>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div class="accordion-content" id="item2">
        ...
        <p>Tel: 55-78-76-76</p>
         ...
         <a style="color: #00b140;" href="Eva_Moreno">
   <i style="text-align: right;" class="fa fa-sign-out"></i>
</a>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div class="accordion-content" id="item3">
         ...
         <a style="color: #00b140;" href="Bertha_von">
   <i style="text-align: right;" class="fa fa-sign-out"></i>
</a>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div class="accordion-content" id="item4">
         ...
         <a style="color: #00b140;" href="Carolina_Agazzi">
   <i style="text-align: right;" class="fa fa-sign-out"></i>
</a>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div class="accordion-content" id="item5">
         ...
         <a style="color: #00b140;" href="Carmen_Serdan">
   <i style="text-align: right;" class="fa fa-sign-out"></i>
</a>
  </div>
                ...
                <div class="col-sm-4" style="padding-left: 0px; padding-right: 0px;">
                      ...
                      <div class="card-block" style="overflow: hidden; border-color: #cacaca; border-style: solid; border-width: 0px 0px 1px 0px; margin-bottom: 0%; margin-left: 3%; padding-right: 25px; padding-right:0px; background-color: #fff;">
                        <p class="card-text" id="texto_tweet"><font color="#00b140">
					     ...
					     <h2 style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;">Carolina Agazzi</h2>
							<br>
							<br><br>
                      </div>
                      <div class="card-block" style="overflow: hidden; border-color: #cacaca; border-style: solid; border-width: 0px 0px 1px 0px; margin-bottom: 0%; margin-left: 3%; padding-right: 25px; padding-right:0px; background-color: #fff;">
