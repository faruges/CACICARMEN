...
<div class="accordions">
  ...
  <div style="background-color: #f2f2f2;" class="accordion-title">
    <a style="text-align: right; color:#00b140;" href="centros_Luz_María">
  ...
  <div style="background-color: #f2f2f2;" class="accordion-title">
    <a style="text-align: right; color:#00b140;" href="centros_Eva_Moreno">
    <h2> Ver información </h2></a>
  </div>
  </div>
  ...
  <div style="background-color: #f2f2f2;" class="accordion-title">
    <a style="text-align: right; color:#00b140;" href="centros_Bertha_von">
    <h2> Ver información </h2></a>
  </div>
  </div>
  ...
  <div style="background-color: #f2f2f2;" class="accordion-title">
    <a style="text-align: right; color:#00b140;" href="centros_Carolina_Agazzi">
    <h2> Ver información </h2></a>
  </div>
  </div>
  ...
  <div style="background-color: #f2f2f2;" class="accordion-title">
    <a style="text-align: right; color:#00b140;" href="centros_Carmen_Serdan">
    <h2> Ver información </h2></a>
  </div>
  </div>
</div>
...
<div class="col-sm-4" style="padding-top: 12px;">      
  ...
  <div class="col-sm-4" style="text-align: center;">
      ...
      <h2 style="font-weight: bold; color:#00B140;">Bertha Von Glümer Leyva</h2>
