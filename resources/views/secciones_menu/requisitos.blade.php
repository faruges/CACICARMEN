                                ...
                                <div class="col-lg-12" style="margin-top: 2%;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <h5>Nota: Los nuevos ingresos pueden registrarse en cualquier momento del
                                                ciclo
                                                escolar.</h5>
                                            <h5><a href="../public/doc/Documentacion_Complementaria_para_Registro.zip"
                                                   download><strong>Descargue, llene, firme los siguientes formatos.
                                    ...
                                    <div class="row contenedor-button-registro">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            <a class="btn btn-lg format-button-regis"
                                               href="{{url('preinscripcion_validar_rfc')}}"><span
                                                    class="btn-registro"
                                        ...
                                        <div class="col-sm-6">
                                            <h5 style="color: #235b52;"><strong>1. Enviar la siguiente documentación
                                                ...
                                                <h5>b) Si la o el menor presenta algún tipo de discapacidad y/o
                                                    ...
                                                    tratamiento.</h5>
                                                <h5 style="1.5rem;">Una vez enviada la documentación y concluido su
                                                    registro en
                                                ...
                                                <h5 style="color: #235b52;"><strong>2. Presentar en el CACI, cuando se
                                                    ...
                                                    <h5>c) Documento legal que dictamine la patria potestad o guarda y
                                                        custodia del
                                                        niño o niña.</h5>
                                                    <h5>d) último comprobante de pago del trabajador o trabajadora</h5>
                                        </div>
                                        <div class="col-sm-6">
                                            <h5 style="color: #235b52;"><strong>3. Entregar en el CACI, cuando se le
                                                    solicite a través de correo electrónico,
                                                    la siguiente documentación en original:</strong>
                                                <h5>a) Análisis clínicos indicados en la confirmación de
                                                    inscripción.</h5>
                                                <h5>b) Cuatro fotografías tamaño infantil, de la niña o niño, recientes
                                                    e
                                                    iguales.</h5>
                                                <h5>c) Dos fotografías tamaño infantil, de la persona tutora, recientes
                                                    e
                                                    iguales.</h5>
                                                <h5>d) Dos fotografías tamaño infantil, recientes e iguales, de dos
                                                    personas
                                                    mayores de edad, autorizadas por el o la solicitante del
                                                    servicio.</h5>
                                                ...
                                                <h5>
                                                    <a href="../public/doc/Documentacion_Complementaria_para_Registro.zip"
                                                       download>Descargue, llene, firme los siguientes formatos.
                                                        Envíelos, en versión PDF, al correo electrónico de su CACI.</a>
                                                </h5>
                                        </div>
                                    </div>
                                    <div class="row contenedor-button-registro">
