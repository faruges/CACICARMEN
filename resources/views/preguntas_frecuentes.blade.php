...
<style>@import url('https://fonts.googleapis.com/css2?family=Raleway:wght@300;400;600;700&display=swap');
* {
    margin: 0;
    padding: 0;
...
<div class="content">
    <div class="accordion">
     ...
     <div class="accordion__item">
        ...
        <div class="accordion__body">
          <p>Si el malestar inicia en caso no deberá asistir al CACI. En el caso de presentarse el malestar en las instalaciones se avisa al servicio médico quien revisa e informa sobre la situación a las personas tutoras.</p>
        ...
        <div class="accordion__body">
          <p>Deberá enviar su solicitud explicando brevemente los motivos, anotar los datos del niño (a) y el CACI que solicita al siguiente correo: mariela_mx@hotmail.com (se sustituirá por el nuevo correo del administrador)</p>
        </div>
      </div>
           <div class="accordion__item">
        ...
        <div class="accordion__body">
          <p>17. Si el semáforo epidemiológico de la CDMX está en verde y decido no llevar a mi hijo(a) ¿Perdería su lugar?</p>
        </div>
      </div>
           <div class="accordion__item">
