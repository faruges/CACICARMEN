...
<div class="container gallery-container">
    ...
    <a style="height: 900px;" class="lightbox" href="{{asset('img/CACI_Caroliona/1.jpg')}}">
    <img src="{{asset('img/CACI_Caroliona/1.jpg')}}" alt="Bridge">
    </a>
    </div>
    <!--<h2>Salón maternal 1</h2>-->
    </div>

    <div class="col-sm-6 col-md-4">
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Caroliona/2.jpg')}}">
    <img src="{{asset('img/CACI_Caroliona/2.jpg')}}" alt="Park">
    </a>
   <!--<h2>Salón de juegos</h2>-->
    ...
    <img src="{{asset('img/CACI_Caroliona/4.jpg')}}" alt="Traffic">
    </a>
    ...
    <div class="col-sm-10 col-md-6">
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Caroliona/5.jpg')}}">
    <img src="{{asset('img/CACI_Caroliona/5.jpg')}}" alt="Tunnel">
    </a>
    <!--<h2>Gimnasio</h2>-->
    </div>
    </div>
