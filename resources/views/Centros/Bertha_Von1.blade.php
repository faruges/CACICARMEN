...
<div class="container gallery-container">
    ...
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Bertha/1.jpeg')}}">
    <img src="{{asset('img/CACI_Bertha/1.jpeg')}}" alt="Park">
    </a>
   ...
   <!-- <h2>Fachada</h2>-->
    ...
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Bertha/8.jpg')}}">
    <img src="{{asset('img/CACI_Bertha/8.jpg')}}" alt="Traffic">
    </a>
