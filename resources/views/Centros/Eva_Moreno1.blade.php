...
<div class="container gallery-container">
    ...
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Eva/5.jpg')}}">
    <img src="{{asset('img/CACI_Eva/5.jpg')}}" alt="Park">
    </a>
    ...
    <div style="color: #333333; font-size: 29px; font-weight: bold; text-transform: none; margin-left: 3%;text-align: center;" class="w3-container">
    <a class="lightbox" href="{{asset('img/CACI_Eva/2.jpg')}}">
    <img src="{{asset('img/CACI_Eva/2.jpg')}}" alt="Traffic">
    </a>
    <!--<h2>Salón maternal 2</h2>-->
    </div>
    </div>
    ...
    <img src="{{asset('img/CACI_Eva/6.jpg')}}" alt="Tunnel">
    </a>
    <!--<h2>Gimnasio</h2>-->
    </div>
    </div>
