                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombre_tutor_madres" name="nombre_tutor_madres"
                                                   class="form-control"
                                                   placeholder="Nombre del Padre/Madre o Tutor"
                                                   value="{{$value['CH_nombres']}}" readonly/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="tipo_nomina_1" placeholder="Tipo de nómina"
                                                   title="Tipo de nómina" class="form-control"
                                                   oninput="this.className = ''" name="tipo_nomina_1"
                                                   value="{{$value['TipoNomina']}}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Número de empleado<span class="text-danger"></span></label>
                                            <input id="num_empleado_1" placeholder="Número de empleado"
                                                   class="form-control"
                                                   title="Número de empleado" oninput="this.className = ''"
                                                   name="num_empleado_1"
                                                   value="{{$value['NumEmpleado']}}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Número de plaza<span class="text-danger"></span></label>
                                            <input id="num_plaza_1" placeholder="Número de plaza"
                                                   title="Número de plaza" class="form-control"
                                                   oninput="this.className = ''" name="num_plaza_1"
                                                   value="{{$value['NUM_PLAZA']}}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Unidad administrativa Área de adscripción<span
                                                    class="text-danger"></span></label>
                                            <input id="unidad_administrativa" type="text"
                                                   placeholder="Clave de la dependencia"
                                                   title="Clave de la dependencia" class="form-control"
                                                   oninput="this.className = ''"
                                                   name="unidad_administrativa" value="{{$value['UA']}}"
                                                   readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Clave de la dependencia<span
                                                    class="text-danger"></span></label>
                                            <input id="clave_dependencia_1" type="text"
                                                   placeholder="Clave de la dependencia"
                                                   title="Clave de la dependencia" class="form-control"
                                                   oninput="this.className = ''"
                                                   name="clave_dependencia_1" value="{{$value['Clave_Dependencia']}}"
                                                   readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Nivel salarial<span class="text-danger"></span></label>
                                            <input id="nivel_salarial_1" placeholder="Nivel salarial"
                                                   title="Nivel salarial"
                                                   class="form-control" oninput="this.className = ''"
                                                   name="nivel_salarial_1"
                                                   value="{{$value['NIVEL_SALARIAL']}}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Sección sindical<span class="text-danger"></span></label>
                                            <input id="seccion_sindical_1" placeholder="Sección sindical"
                                                   class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="alcaldia" type="text" placeholder="Alcaldía" title="Alcaldía"
                                                   class="form-control"
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label style="font-family: Arial, Helvetica; color:#777777;">Nombre(s)<span
                                                    class="text-danger"></span></label>
                                            <input type="text" id="nombre_menor_1" placeholder="Nombre(s) del menor"
                                                   class="form-control"
                                                   title="Nombre(s) del menor" oninput="this.className = ''"
                                                   name="nombre_menor_1" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="font-family: Arial, Helvetica; color:#777777;">Apellido
                                                paterno<span
                                                    class="text-danger"></span></label>
                                            <input type="text" id="apellido_paterno_1" placeholder="Apellido paterno"
                                                   class="form-control"
                                                   title="Apellido paterno" oninput="this.className = ''"
                                                   name="apellido_paterno_1" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="font-family: Arial, Helvetica; color:#777777;">Apellido
                                                materno<span
                                            ...
                                            <input type="text" id="apellido_materno_1" placeholder="Apellido materno"
                                                   ...
                                                   class="form-control" oninput="this.className = ''"
                                                   name="apellido_materno_1" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="font-family: Arial, Helvetica; color:#777777;">CURP<span
                                                    class="text-danger"></span></label>
                                            <input type="text" id="curp_num" placeholder="CURP" title="CURP"
                                                   oninput="this.className = ''"
                                        ...
                                        <div class="form-group">
                                            <label
                                                ...
                                                for="birthday">Fecha
                                                de Nacimiento de la niña o niño:<span
                                                    class="text-danger"></span></label>
                                        ...
                                        <div class="form-group">
                                            <label
                                                style="font-size: 15px; font-family: Arial, Helvetica; color:#777777;">Edad
                                                de la niña o niño
                                        ...
                                        <div class="form-group">
                                            <label
                                                ...
                                                Atención y Cuidado Infantil deseado: <span
                                                    class="text-danger"></span></label>
                                            <select style="font-size: 15px; padding-bottom: 5px;" name="caci" id="caci"
                                                    class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label
                                                ...
                                                de
                                                vacunación, solo las páginas de datos identificativos, esquema de
                                                vacunación y estado
                                                nutricional.</label>
                                            <div class="js-upload uk-placeholder uk-text-center"
                                                 style="margin-top: 0rem;">
                                    ...
                                    <div class="col-sm-6"><br>
                                        ...
                                        <div class="form-group">
                                            <label
                                                style="font-family: Arial, Helvetica; color:#777777; margin-bottom:0rem; margin-top:0rem;">En
                                                caso de que el trabajador o
                                                trabajadora no
                                                sea el padre o madre biológico, deberá anexar el
                                                documento legal que dictamine la patria potestad y/o guarda y custodia
                                                de la niña o el
                                                niño.</label>
                                            <div class="js-upload uk-placeholder uk-text-center"
                                                 style="margin-top: 0rem;">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email_correo" placeholder="E-mail" title="E-mail"
                                           oninput="this.className = ''"
                                           class="form-control" name="email_correo" value="{{$value['CH_mail']}}">
                                </div>
                                <div class="form-group">
                                    <label>Teléfono a 10 dígitos<span class="text-danger"></span></label>
                                    <input id="telefono_celular" type="tel" placeholder="Teléfono" title="Teléfono"
                                           class="form-control"
                                           oninput="this.className = ''" name="telefono_celular" maxlength="10"
                                           pattern="[0-9]{10}">
                                </div>
                                <div class="form-group">
                                    <label>Celular a 10 dígitos<span class="text-danger"></span></label>
                                    <input id="telefono_3" type="tel" placeholder="Celular" title="Celular"
                                           class="form-control"
                                           oninput="this.className = ''" name="telefono_3" maxlength="10"
                                           pattern="[0-9]{10}">
                                </div>
