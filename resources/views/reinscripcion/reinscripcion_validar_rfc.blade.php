...
@section('mycontent')
    ...
    <div style="font-size: 20px; text-align: center; font-weight: 500; font-size: 1.40rem; color: #646464;" style="text-align: center;" class="container">
  ...
  <a href="mailto:cacicarmenserdan@finanzas.cdmx.gob.mx" aria-label="correo electrónico" style="color:#9F2241;" target="_blank">cacicarmenserdan@finanzas.cdmx.gob.mx</a></span></strong></p>
            ...
            <img id="centrador-caci" class="card-img-top imagen-tamano2" src="img/5 NIÑOS.svg" style=" width: 600%;
  height: 100px;">
