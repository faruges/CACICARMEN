                            ...
                            @foreach ($lista_reinscripcion as $reinsc)
                                ...
                                <div class="row row-margin">
                                    <h3>Nombre Menor:</h3><h3 class="font-label">{{$reinsc->nombre_menor}}
                                        {{$reinsc->ap_paterno}} {{$reinsc->ape_materno}}</h3>
                                </div>

                                {{--                            <div class="row row-margin">--}}
                                {{--                                <h3>All:</h3><label class="font-label">{{$reinsc}}}</label>--}}
                                {{--                            </div>--}}
                                <div class="row row-margin">
               ...
               @can('view_form_datos_repositorio')
                    <div class="row">
                        <div class="card mx-auto col-md-10 col-lg-10 col-xl-10">
                            ...
                            <div class="card-body">
                                @foreach ($listaDatosReposRe as $item => $reinscripcion)
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="fecha_preins" type="text" placeholder="Fecha de inscripción" class="form-control" title="Fecha de inscripción" oninput="this.className = ''" name="fecha_preins" value="{{$reinscripcion['fecha_preins']}}">
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label>Fecha de Nacimiento<span class="text-danger"></span></label>
                                                        <input type="text" id="fecha_nac_padre" name="fecha_nac_padre" class="form-control" placeholder="Fecha de Nacimiento" value="{{$reinscripcion['fecha_nac_padre']}}" />
                                                        <label>Edad<span class="text-danger"></span></label>
                                            ...
                                            <div class="tab-pane fade" id="kt_tab_pane_4_4" role="tabpanel" aria-labelledby="kt_tab_pane_4_4">
                                                ...
                                                <div style="overflow:auto;">
                                                    <div style="float:right;">
                                                        <button type="button" id="updateDatosRepoRe" style="border-radius: 5px; background-color: #17a2b8;" onclick="editRepositorioReins({{$id}},{{$idRepositorio}},{{$idPersonaAutorizadaUno}},{{$idPersonaAutorizadaDos}})"><i class="fa fa-refresh"></i> Actualizar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                ...
                <span class="float-right btn-regresar mt-5">
                    ...
                    <button type="button" id="delete_registro_sol" title="Borrar Registro del Solicitante" name="delete_registro_sol" onclick="del_reg_solicitante('{{$id}}','{{$nameUser}}','lista_reinscripcion','inscripcion_menor','inscripcion_menor_id','inscripcion')" class="btn btn-lg btn-danger"><i class="fa fa-trash"></i>Borrar Registro</button>
                </span>
                </div>
            </div>
        </div>
