        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h2 class="cdmx-colorv">
                    Datos Repositorio Reinscripción
                </h2>
            </div>
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <form method="POST" action="{{route('get_list_repo_reins_by_ciclo')}}"
        ...
        <div class="card-body" style="overflow: auto">
            <div class="portlet-body flip-scroll">
                <table id="tableRegs" class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        @foreach ($datosReposReins as $repo)
                        <tr>
                            <td>{{$repo['caci']}}</td>
                            ...
                            <td>
                                <span>
                                    <a class="btn btn-lg btn-outline-primary"
                                        href="{{route('ver_detalles_repo_reins',$repo['id'])}}"
